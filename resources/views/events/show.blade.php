  ...
  <div class="col-md-10 offset-md-1">
    <div class="row">
      ...
      <div id="info-container" class="col-md-6">
        ...
        @else
          <p class="already-joined-msg"><br>Você já está participando deste evento.</p>
        @endif

        <h3><br>O evento conta com:</h3>
        <ul id="items-list">
          @foreach ($event->items as $item)
            <p><ion-icon name="play-outline"></ion-icon><span>{{ $item }}</span></p>
          @endforeach
        </ul>
